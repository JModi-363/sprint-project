...
def main():
    ...
    save_data_and_label(customer=f"{first_name} {last_name}", location=location, total=final_price, tax=calculated_tax)
    print(f"\nUpdated Files {DATA_FILE} and {HUMAN_REPORT}.")
    print_data_and_label(customer=f"{first_name} {last_name}", location=location, total=final_price, tax=calculated_tax)
